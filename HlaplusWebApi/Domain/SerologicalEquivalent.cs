...
namespace HlaplusWebApi.Domain
{
    ...
    public partial class SerologicalEquivalent
    {
        public string Locus { get; set; }
        public string Name { get; set; }
        public string UnambiguousSerology { get; set; }
        public string PossibleSerology { get; set; }
        public string AssumedSerology { get; set; }
        public string ExpertAssignedException { get; set; }
